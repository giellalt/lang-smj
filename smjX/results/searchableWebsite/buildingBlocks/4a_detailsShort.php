<script>
<!--
document.write("<div id='detailsShortHeader' style='width:300px;padding:10px;margin-top:"+topOffset+"px;float:right;position:fixed;margin-left:"+leftOffset+"px;background-color:#FFFFFF;'>");
//-->
</script>
