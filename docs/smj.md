 ...
 * __LEXICON Acronym-smi   __ divides the acros in the 3 types just9 mentioned.
...
Here is the list9 of acronym nouns (not propernouns)
...
Here is the list9 of lexicalised Sem/Org acronym proper nouns 
...
Here is a list9 of lexicalised acronyms without semtags. 
 ...
 * __LEXICON LETTERNUMBER   __ contains a list9 of letters and numbers
 ...
 * **LEXICON FirstComponentProper ** Proper shortcomponents


 * **LEXICON ProperNoun-smj ** Lule Saami proper nouns
 ...
 * __LEXICON ProperNoun-smi-nocomp __ Propernouns: no compounding without hyph. Add also +CmpNP/None
 ...
 ARS% Reasearch+MWE+CmpNP/First+OLang/UND:ARS% Reasearch BERN-org ;  \\
 Ap+CmpNP/None+OLang/UND:Ap BERN-org ;  \\


 * __LEXICON ProperNoun-smi __ Propernouns
 Aabakken+OLang/NOB:Aa^bakken LONDON-sur ;  \\
 Aabel+OLang/NOB:Aabel LONDON-sur ;  \\
 Aabenraa+OLang/NOB:Aabenraa NYSTØ-sur ;  \\
 Frykman+OLang/NOB:Frykman LONDON-sur ;  \\
ERVASTI?
