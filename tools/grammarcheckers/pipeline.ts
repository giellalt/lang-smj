...
export default function smjGramRelease(entry: StringEntry): Command {
  ...
  x = cg3.vislcg3(x, {
    model_path: "grc-disambiguator.bin",
  });
  x = cg3.vislcg3(x, {
    model_path: "spellchecker.bin",
  });
  x = cg3.vislcg3(x, {
    model_path: "after-speller-disambiguator.bin",
  });
  x = cg3.vislcg3(x, {
    model_path: "grammarchecker-release.bin",
  });
  x = divvun.suggest(x, {
