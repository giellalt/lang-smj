...
This directory contains source files for the Lule Sami language
...
-   <https://giellalt.uit.no/lang/smj/j-smj.html> (analyser)
...
The Lule Sami language sources can be acquired using [giella SVN
